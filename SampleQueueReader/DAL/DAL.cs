/// \file DAL
///
/// \mainpage Advanced SQL (PROG3070)- Data Access Layer
///
...
namespace DALlib
{
    public class DAL
    {
        ...
        /// <summary>
        /// Get the final yield information from database
        /// </summary>
        /// <param name="conn"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// get the information for defect numbers
        /// </summary>
        /// <param name="conn"></param>
        /// <returns></returns>
