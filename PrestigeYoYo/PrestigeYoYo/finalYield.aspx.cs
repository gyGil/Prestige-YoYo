...
{
    public partial class finalYield : System.Web.UI.Page
    {
        SqlConnection conn;
        ...
        /// <param name="e"></param>
        protected void btnFinalYield_Click(object sender, EventArgs e)
        {
            this.ctFinalYield.Visible = true;   // make diagram visible
            this.gvFinalYield.Visible = true;

            DAL dal = new DAL();
            Dictionary<string, int> dic = dal.QueryFinalYieldTotal(this.conn);
            ...
            if(this.ddlStation.Text == "4")
            {
                ...
                this.ctFinalYield.DataSource = dtDefect;
                this.ctFinalYield.DataBind();
            }
                     ...
                     this.ddlStation.Text == "3")
            {
                ...
                drEachStation[0] = "Reject numbers";
                drEachStation[1] = defectNumForStation;
                dtEachStation.Rows.Add(drEachStation);

                this.ctFinalYield.DataSource = dtEachStation;
                this.ctFinalYield.DataBind();
            }            

            this.gvFinalYield.DataSource = dtTotal;
            this.gvFinalYield.DataBind();
        ...
        private void SetColor(string type)
        {
            ...
            this.ctFinalYield.Palette = ChartColorPalette.None;
            this.ctFinalYield.PaletteCustomColors = myPalette;
        }
    }
}